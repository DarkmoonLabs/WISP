...
{
    /// <summary>
    /// Listens for connections on port 943 and dispatches requests to a PolicyConnection.  Partial trust Silverlight application
    /// can not connect to any remote machines unless those machines run a policy server, such as this one.  The policy server
    /// must run on Port 943 in order for Silverlight applications to find it.
    ...
    /// <summary>
    /// Encapsulate and manages state for a single connection from a Silverlight client
    /// </summary>
