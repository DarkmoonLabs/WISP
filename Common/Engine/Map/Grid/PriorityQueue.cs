...
namespace Shared
{
    public class ASPriorityQueue<T> where T : IIndexedObject
    {
        ...
        public ASPriorityQueue(IComparer<T> comparer)
        {
            mComparer = comparer;
        }

        public ASPriorityQueue(IComparer<T> comparer, int capacity)
        {
            mComparer = comparer;
